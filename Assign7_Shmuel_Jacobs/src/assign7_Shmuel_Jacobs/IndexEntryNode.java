...
/**
 * Single index entry, implements binary node.
 *
...
public class IndexEntryNode {
    ...
    /**
     * Compare index listings to find precedence. Really just compares Strings
     * in the "word" field.
     *
     * @param listing index entry to compare to
     * @return positive int if calling entry is greater value than parameter, 0
     * if they're equal, negative int otherwise.
     */
    ...
    /**
     * Create String to show index entry, with lookup word and list of
     * appearances.
     *
    ...
    /**
     * Check if this entry is the same as the entry in parameter. Used by tree
